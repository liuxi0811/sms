...
renderLegend(){
	this.drawLegend(COLOR.MACHINE.TYPE_A,25,'教师');
	this.drawLegend(COLOR.MACHINE.TYPE_B,50,'班主任');
	this.drawLegend(COLOR.MACHINE.TYPE_C,75,'已就业学员');
	this.drawLegend(COLOR.MACHINE.TYPE_D,100,'在读学员');
						...
						series : [
							{
								...
								data:[
									{value:4600, name:'教师'},
									{value:4600, name:'班主任'},
									{value:15600, name:'已就业学员'},
									{value:6600, name:'在读学员'},
...
renderLayer04Right(){
	...
	myChart.setOption({
			...
			legend: {
				...
				orient:'vertical',
				data:[
						{name:'UI/UE',icon:'circle'},
						{name:'JAVA',icon:'circle'},
						{name:'WEB',icon:'circle'}
					]
			},
			grid: {
				left: '3%',
